...
console.log(`Ex.12., ${floor} and ${ceil}`);
console.log("---------------------------------");
...
console.log("Ex.13.", "Are you a student?", isStudent);
console.log("---------------------------------");
...
let numberEx9 = 6;
console.log("Ex.24.", "İlk değer:", numberEx9);
++numberEx9;
console.log("Ex.24.", "Arttirilmiş değer:", numberEx9);
console.log("---------------------------------");
...
let numberEx10 = 8;
console.log("Ex.25.", "İlk değer:", numberEx10);
numberEx10++;
console.log("Ex.25.", "Arttirilmiş değer:", numberEx10);
console.log("---------------------------------");
