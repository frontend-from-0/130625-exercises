...
const num1 = 3.7;
const num2 = 3.2;
console.log("Ex.12.", Math.floor(num1));
console.log("Ex.12.", Math.ceil(num2));
...
console.log(
  `Ex.18.The quotient is ${divisionResult} and the difference is ${differenceResult}.`,
);
...
let counter1 = 0;
counter1++;
console.log("Ex.22. First method", counter1);
counter1 += 1;
console.log("Ex.22.Second method", counter1);
counter1 = counter1 + 1;
console.log("Ex.22.Third method", counter1);
