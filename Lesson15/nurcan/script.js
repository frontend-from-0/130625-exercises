...
const number1 = 3.7;
const number2 = 3.2;
console.log('Ex.12.',Math.floor(number1));
console.log('Ex.12.',Math.ceil(number2));
...
console.log('Ex.16',`${person.name} ${(person.age)} lives in ${person.city}`);
