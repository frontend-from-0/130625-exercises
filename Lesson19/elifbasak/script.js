...
class ShoppingCart {
  ...
  getTotal() {
    console.log("Calculating the total cost of the cart....");
    let total = 0;
    for (const item of this.#items) {
      total += item.quantity * item.price.amount;
    }
    console.log(`Total amount of the cart is ${total} TRY.`);
    return total;
  }
...
myCart.addItem("Shoes", { amount: 100, currency: "TRY" }, 3);
myCart.addItem("Dress", { amount: 70, currency: "TRY" }, 2);
myCart.addItem("Shirts", { amount: 50, currency: "TRY" }, 3);
