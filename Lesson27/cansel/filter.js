...
const usersExercise4 = [
  ...
  { id: 4, name: 'Emily', age: 21, email: 'emily@example.com' },
  { id: 5, name: 'Michael', age: 35, email: 'michael@example.com' },
  { id: 6, name: 'Sara', age: 29, email: 'sara@example.com' },
  { id: 7, name: 'David', age: 42, email: 'david@example.com' },
  { id: 8, name: 'Olivia', age: 31, email: 'olivia@example.com' },
  { id: 9, name: 'Daniel', age: 27, email: 'daniel@example.com' },
  { id: 10, name: 'Sophia', age: 23, email: 'sophia@example.com' },
];
...
const productsExercise6 = [
  { name: 'Laptop', brand: 'Apple', price: 1999, quantity: 0 },
  { name: 'Smartphone', brand: 'Samsung', price: 899, quantity: 20 },
  { name: 'TV', brand: 'LG', price: 1499, quantity: 15 },
  { name: 'Headphones', brand: 'Sony', price: 299, quantity: 30 },
  { name: 'Smartwatch', brand: 'Apple', price: 399, quantity: 25 },
  { name: 'Camera', brand: 'Canon', price: 999, quantity: 0 },
  { name: 'Gaming Console', brand: 'Microsoft', price: 499, quantity: 8 },
  { name: 'Tablet', brand: 'Samsung', price: 649, quantity: 18 },
  { name: 'Smart Speaker', brand: 'Amazon', price: 99, quantity: 0 },
  { name: 'Fitness Tracker', brand: 'Fitbit', price: 129, quantity: 14 },
];
...
console.log(numbersExercise7.filter((num) => num % 3 !== 0));
...
const studentsExercise9 = [
  ...
  { id: 3, name: 'Charlie', age: 20, grade: 'B+' },
  { id: 4, name: 'David', age: 19, grade: 'A-' },
  { id: 5, name: 'Emma', age: 18, grade: 'A+' },
  { id: 6, name: 'Frank', age: 20, grade: 'B' },
  { id: 7, name: 'Grace', age: 19, grade: 'D+' },
  { id: 8, name: 'Hannah', age: 20, grade: 'A-' },
  { id: 9, name: 'Isaac', age: 18, grade: 'D' },
  { id: 10, name: 'Julia', age: 19, grade: 'B-' },
];

console.log(studentsExercise9.filter((student) => !student.grade.startsWith('D') && !student.grade.startsWith('F')));
