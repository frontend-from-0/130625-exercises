...
console.log('Element counts of ex. 3: ', elementCounts); // Output: { a: 3, b: 2, c: 1 }
...
console.log('Average of ex. 4: ', average);
...
console.log('Unique count of ex. 5: ', uniqueCount); // Output: 5
