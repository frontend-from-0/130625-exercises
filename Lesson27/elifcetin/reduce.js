...
const findMax = numbersEx2.reduce((currentValue, num) => {
 // return num > currentValue ? num : currentValue -> ternary operator if i want.
 if(num > currentValue){
  return num
 }else{
  return currentValue
...
const findAverage =
 numbersEx4.reduce((sum, current) => sum + current, 0) / numbersEx4.length;
