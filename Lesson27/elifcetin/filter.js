...
console.log(wordsExercise8.filter(character => character.length > 5))
...
console.log(
  studentsExercise9.filter(
    grades => gradeL.indexOf(grades.grade) > gradeL.indexOf("C")
  )
);
...
console.log(usersExercise10.filter(userName => userName.name.startsWith('J')))
