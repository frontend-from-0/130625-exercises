...
const notDivisibleBy3 = numbersExercise7.filter(num => num % 3 !== 0);
...
const passingStudents = studentsExercise9.filter(student => !['D', 'D+', 'F'].includes(student.grade));
...
const namesWithoutJ = usersExercise10.filter(user => !user.name.startsWith('J'));
console.log(namesWithoutJ);