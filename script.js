...
const number1 = 3.7;
const number2 = 3.2;
console.log(Math.floor(number1), Math.ceil(number2));
...
console.log('Value after postfix increment:', numberEx10);  

// 26. Declare numberEx11=-3. Increment it by 1 using prefix ++, then multiply the result by 2 and log the final value.
// CODE HERE
let numberEx11 = -3;
const incrementedValue = ++numberEx11;
