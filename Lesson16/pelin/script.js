...
console.log(
  ...
  filterNegative([5, -2, 0, 15, -8, 3, -7, 16])
);
/*
...
const doubled = doubleValues([5, 72, 99, 14]);
...
const testObject = { a: 10, b: 20, c: 5 };
console.log("The sum is", sumObjectValues(testObject));
...
const testTheObject = { name: "Alice", age: 25 };
printObjectKeys(testTheObject);
...
console.log("The sum of array is", sumWithDoWhile([1, 2, 3, 4, 5]));
...
function removeDuplicates(arr) {
  let uniqueArr = [];
  for (const duplicates of arr) {
    if (!uniqueArr.includes(duplicates)) uniqueArr.push(duplicates);
  }
  return uniqueArr;
}
const testArray = [1, 5, 2, 1, 5, 8, 2, 9, 2];
console.log("Array without duplicates is", removeDuplicates(testArray));
/*
...
const inputNumber = 5;
const testFactorial = factorial(inputNumber);
console.log(`The result of ${inputNumber} factorial is`, testFactorial);
...
console.log(
  "A reversed sentence is:",
  reverseWords("Loops are useful in programming")
);
